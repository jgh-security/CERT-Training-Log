# 1. 요일별 폴더 생성
mkdir -p week2/{1_monday,2_tuesday,3_wednesday,4_thursday,5_friday}/

# 2. 월~목요일 screenshots 폴더 생성 및 Git 추적용 파일(.gitkeep) 생성
for day in 1_monday 2_tuesday 3_wednesday 4_thursday; do
    mkdir -p week2/$day/screenshots
    touch week2/$day/screenshots/.gitkeep
    touch week2/$day/commands.md
done

# 3. 금요일은 screenshots 없이 파일만 생성
touch week2/5_friday/checklist.md

# 4. 2주차 메인 README.md 생성
...
echo "? 2주차 폴더와 .gitkeep 파일 생성이 완료되었습니다!"
ls -R week2