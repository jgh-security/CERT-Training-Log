...
- **실습 목표:** 공격 도구(Kali), 타겟 서버 로그, 네트워크 패킷의 타임스탬프와 데이터를 상호 대조하여 공격의 실체와 성공 시점을 기술적으로 증명함.
